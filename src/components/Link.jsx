...
const Link = () => {
  return (
    <div className="relative flex items-center justify-center h-max py-10">
      <a href='Amirbek_Nomruodov _Frontend_developer.pdf'
        download="Amirbek_Nomruodov_Frontend_developer.pdf"
        style={{ zIndex: 1000 }}
        className="circle relative w-64 h-64 flex items-center justify-center">
        <a href='' className="text-gray-200 font-mono text-2xl">{'<Download Resume/>'}</a>
